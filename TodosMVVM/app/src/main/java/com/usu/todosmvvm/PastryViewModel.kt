...
class PastryViewModel: ViewModel() {
    ...
    var pastry = Pastry( id = 1, pastries = 0, clickMultiplier = 1, offLineProduction = 0, autoClicker = 0, clickUpgradeCost = 100, autoClickUpgradeCost = 500, offLineProductionUpgradeCost = 1000)
    fun click(){
